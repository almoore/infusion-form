...
try {
    jQuery(function ($) {
        ...
        $('head').append('<link id="templateCSS" rel="stylesheet" href="//alexmoorecomputers.com/infusion/template2.css" />');
        ...
        $('form').append('<br />&nbsp;<br /><div class="text-center well">Change the template: <a class="changeTemplate" href="#Template1" rel="//alexmoorecomputers.com/infusion/template1.css">Template 1</a> | <a class="changeTemplate" href="#template2" rel="//alexmoorecomputers.com/infusion/template2.css">Template 2</a></div>');
